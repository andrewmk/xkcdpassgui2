...
layout += [
    ...
    C(h=40),
    [sg.Button('Generate', k='-GEN-', p=0, button_color='white on red', s=(20, 2), font='Courier 20', bind_return_key=True)]
]

window = sg.Window('XKCD password generator', layout, element_justification='centre', size=(600, 800), finalize=True)
